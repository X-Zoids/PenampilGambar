...
public class PilihGambarButtonFullScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        postgreesqlLB.setBackground(new java.awt.Color(102, 204, 255));
        postgreesqlLB.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        postgreesqlLB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/PostgreSQL.jpg"))); // NOI18N
        ...
        glassfishBT.setBackground(new java.awt.Color(0, 204, 102));
        glassfishBT.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 11)); // NOI18N
        glassfishBT.setForeground(new java.awt.Color(0, 0, 153));
        ...
        javaeeBT.setBackground(new java.awt.Color(0, 204, 102));
        javaeeBT.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 11)); // NOI18N
        javaeeBT.setForeground(new java.awt.Color(0, 0, 153));
        ...
        postgreesqlBT.setBackground(new java.awt.Color(0, 204, 102));
        postgreesqlBT.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 11)); // NOI18N
        postgreesqlBT.setForeground(new java.awt.Color(0, 0, 153));
        ...
        exitBT.setBackground(new java.awt.Color(0, 204, 102));
        exitBT.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 11)); // NOI18N
        exitBT.setForeground(new java.awt.Color(0, 0, 153));
        exitBT.setText("Exit");
